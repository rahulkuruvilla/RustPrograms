...
> {
    ...
    pub contributions: BTreeMap<usize, DKGTranscriptParticipant<E, SPOK, SSIG>>, // a BTree map with each c_i in it
    pub pvss_share: PVSSShare<E>,
}
                ...
                |i| match (self.contributions.get(&i), other.contributions.get(&i)) {
                    (Some(a), Some(b)) => {
                        ...
                        let transcript_participant = DKGTranscriptParticipant {
                            c_i: a.c_i,                                   //c_i
                            weight: a.weight + b.weight,                  //w_i
                            c_i_pok: a.c_i_pok.clone(),
                            signature_on_c_i: a.signature_on_c_i.clone(), //sigma_i
                        };
